...
layout_line4 = QVBoxLayout()  # Сделал вертикальным, чтобы кнопки были друг под другом
...
layout_line4.addWidget(btn_ok, alignment=Qt.AlignHCenter)  # Кнопка "Відповісти"
